defmodule BidhypeWeb.UserControllerTest do
  use BidhypeWeb.ConnCase

  alias Bidhype.Accounts

  @create_attrs %{avatar: "some avatar", email: "some email", first_name: "some first_name", gender: 42, last_name: "some last_name", mobile: "some mobile", password_hash: "some password_hash"}
